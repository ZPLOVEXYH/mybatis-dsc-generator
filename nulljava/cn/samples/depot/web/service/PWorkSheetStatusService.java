/**
 * @filename:PWorkSheetStatusService 2019年7月16日
...
/**   
 *  
 * @Description:  作业单状态表——SERVICE
 * @Author:       ZhangPeng   
 * @CreateDate:   2019年7月16日
 * @Version:      V1.0
 *    
 */
public interface PWorkSheetStatusService extends IService<PWorkSheetStatus> {
...
==> idType  [in template "service.ftl" at line 32, column 44]
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${idType}  [in template "service.ftl" at line 32, column 42]
----
...
freemarker.core.InvalidReferenceException: [... Exception message was already printed; see it above ...]
	...
	at com.github.mybatis.fl.util.Generator.createService(Generator.java:65)
	at com.github.mybatis.fl.test.MyGenerator.main(MyGenerator.java:74)
